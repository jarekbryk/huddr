...
2. Give it a title and leave the output format as HTML and use "Source" as the display type, then click **Create**.
...
- **Ctrl+Enter** (Windows) / **Cmd+Enter** (macOS) — run the current line or selected code. This is the most important keyboard shortcut. Also, when you highlight a piece of code and click **Ctrl+Enter**/**Cmd+Enter**, the highlighted code (and only it) will be executed. This is very useful for debugging multi-step pipes.
...
1.  Name the data and input an arrow pointing to the data \<-
...
::: callout-tip
## What to check after loading data
