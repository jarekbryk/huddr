...
![Screenshot of a chatGPT conversation, in which it claims there are three letters "b" in word "blueberry"](images/blueberry_chatgpt.png){fig-cap="Screenshot of a particularly puzzling chatGPT conversation. Source: [Kieran Healy](https://kieranhealy.org/blog/archives/2025/08/07/blueberry-hill/)"}

## How to learn R

![Screenshot of a fake book covers in style of O'Reilly books, with title "Changing stuff and seeing what happens", with a tagline: "How to actually learn any news programmning concept." "](images/how_to_learn_r.png){fig-cap="Exactly what it says on the cover."}
