...
Secondly, with support from the LLMs readily available, students can concentrate on extracting meaning from data, effectively using their existing knowledge of biological systems to interpret patterns identified in the data (potentially with help of the LLMs), which is the most challenging part of all.

At this point, however, we do not directly _teach_ the use of LLMs for coding, as we consider the purpose of the classes to be to acquire fundamental competencies in programmatic data analysis.
